...
RESOURCES += src/qt/ethf.qrc src/qt/ethf_locale.qrc

TRANSLATIONS += src/qt/locale/ethf_bg.ts \
                src/qt/locale/ethf_de.ts \
                src/qt/locale/ethf_en.ts \
                src/qt/locale/ethf_es.ts \
                src/qt/locale/ethf_fi.ts \
                src/qt/locale/ethf_fr.ts \
                src/qt/locale/ethf_it.ts \
                src/qt/locale/ethf_ja.ts \
                src/qt/locale/ethf_pl.ts \
                src/qt/locale/ethf_pt.ts \
                src/qt/locale/ethf_ru.ts \
                src/qt/locale/ethf_sk.ts \
                src/qt/locale/ethf_sv.ts \
                src/qt/locale/ethf_vi.ts \
                src/qt/locale/ethf_zh_CN.ts \
                src/qt/locale/ethf_zh_TW.ts
