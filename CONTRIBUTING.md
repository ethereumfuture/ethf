Contributing to ETHF Core
============================

The ETHF Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ETHF Core project, and is not to be
confused with overall ETHF Network Protocol consensus changes.

Whether a pull request is merged into ETHF Core rests with the project merge
...
The project leader is the release manager for each ETHF Core release.
