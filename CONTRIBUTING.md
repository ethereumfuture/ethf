Contributing to Ethereum Future Core
============================

The Ethereum Future Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ethereum Future Core project, and is not to be
confused with overall Ethf Network Protocol consensus changes.

Whether a pull request is merged into Ethereum Future Core rests with the project merge
...
Patches that change Ethf consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ethf consensus, it must have been
...
The project leader is the release manager for each Ethereum Future Core release.
