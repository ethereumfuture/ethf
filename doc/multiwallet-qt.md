...
In order to support loading of multiple wallets in ethf-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ethf.cpp.
...
Changes to ethf.cpp
----------------------
ethf.cpp is the entry point into ethf-qt, and as such, will require some minor modifications to provide hooks for
