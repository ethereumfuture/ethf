...
* WebSocket: [https://github.com/ETHF-Project/insight-api-ethf#web-socket-api](https://github.com/ETHF-Project/insight-api-ethf#web-socket-api) 
* API: [https://github.com/ETHF-Project/insight-api-ethf#swifttx-transactions](https://github.com/ETHF-Project/insight-api-ethf#swifttx-transactions) 
...
By default, the ETHF Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ETHF Core daemon:
