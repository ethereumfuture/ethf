...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ethf features */
        {"ethf", "masternode", &masternode, true, true, false},
        {"ethf", "listmasternodes", &listmasternodes, true, true, false},
        {"ethf", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ethf", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ethf", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ethf", "masternodedebug", &masternodedebug, true, true, false},
        {"ethf", "startmasternode", &startmasternode, true, true, false},
        {"ethf", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ethf", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ethf", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ethf", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ethf", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ethf", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ethf", "mnbudget", &mnbudget, true, true, false},
        {"ethf", "preparebudget", &preparebudget, true, true, false},
        {"ethf", "submitbudget", &submitbudget, true, true, false},
        {"ethf", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ethf", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ethf", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ethf", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ethf", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ethf", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ethf", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ethf", "checkbudgets", &checkbudgets, true, true, false},
        {"ethf", "mnsync", &mnsync, true, true, false},
        {"ethf", "spork", &spork, true, true, false},
        {"ethf", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ethf", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ethfd, or the -server option to ethf-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ethf-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52544/\n";
}
