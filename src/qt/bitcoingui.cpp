                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ETHF Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ETHF Core"), this);
    aboutAction->setStatusTip(tr("Show information about ETHF Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ETHF Core help message to get a list with possible ETHF command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ETHF Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("ETHF Core"); // default title
