...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ethereum Future Core"),
     ...
     * override -datadir in the ethf.conf file in the default data directory
     * (to be consistent with ethfd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
