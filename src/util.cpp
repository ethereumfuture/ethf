...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ethf.conf"));
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty ethf.conf if it does not exist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ethfd.pid"));
