...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ethereum Future Core ethf-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ethf-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ethf transaction") + "\n" +
                               "  ethf-tx [options] -create [commands]   " + _("Create hex-encoded ethf transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ethf transaction
